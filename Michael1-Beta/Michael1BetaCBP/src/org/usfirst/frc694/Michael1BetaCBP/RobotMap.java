...
public class RobotMap {
    ...
    public static Relay shooterShooterMotorController;
    ...
    public static void init() {
        ...
        acquirerAcquirerMotorControllerTop = new Talon(2);
        acquirerAcquirerMotorControllerBottom = new Talon(3);
        ...
        shooterShooterMotorController = new Relay(0);
